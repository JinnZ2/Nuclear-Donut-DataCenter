...
| Python 3 | Simulation scripts (`harmonic_sim.py`, `water_sim.py`) — requires `numpy`, `matplotlib` |
...
| `water_sim.py` | Simulation | Monthly water budget, recovery, Coriolis water effects |
