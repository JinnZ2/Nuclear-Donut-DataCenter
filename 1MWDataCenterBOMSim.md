# Expanded Materials List - Real Data Center (1 MW Module)

## 1. Central AI Control and Sensor Systems

- 1x Redundant AI Control Server Cluster (2N)
- 500+ Swarm-logic thermal and humidity sensors (buried + airborne)
...
## 2. Steam-Vortex and Spiral Condenser System
...
## 3. Adaptive Ventilation and Heat Control
...
- 12x Swarm-monitored soil temperature and RH zones
- 4x Subsurface expansion tanks (thermal buffer)
- 2x Redundant geothermal fluid circulation pumps

---

## 5. Phase Change and Buffering Systems

- 8x Paraffin or bio-based PCM containers (~500 kg total capacity)
...
## 6. Server Racks and Radial Layout
...
## 8. Power and Energy Integration

- Grid connection + nuclear microgrid sync switch
- 1x 1 MW inverter + DC load controllers
...
## 9. Security and Emergency Protocol Layers
